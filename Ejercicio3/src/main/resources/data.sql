...
insert into cajas(numreferencia,contenido,valor,almacen) values ('111AB','Elemento 2',10,1);
insert into cajas(numreferencia,contenido,valor,almacen) values ('111AC','Elemento 3',30,2);